  ...
  const games = [
    {
      ...
      author: "Zozak",
      twitter: "https://x.com/AkifhanIlgaz",
    },
    {
      id: "faces",
      title: "EthOS Faces",
    ...
    },
    {
      id: "updown",
      title: "$AIR Up / Down",
      description: "Predict if $AIR token price will go up or down!",
    ...
    <div className="flex items-start justify-center min-h-screen">
      ...
      <div className="container mx-auto px-4 py-8 flex flex-col items-center justify-center">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-white mb-4">Eth OS Games</h1>
          <p className="text-gray-300 text-lg">Play fun games and get code!</p>
        </div>
